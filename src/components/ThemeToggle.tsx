...
import { getPrefs, toggleTheme, type Theme } from "@/lib/prefs";

// Sun/moon toggle for light/dark mode. Reads the persisted pref on mount so it
// matches the no-flash theme already applied by the inline script in layout.
